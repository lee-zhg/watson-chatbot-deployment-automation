...
async function main(event) {
  ...
  //cos_apikey = event.cosApiKey;
  //cos_resource_instance_id = event.cosInstanceId;
  cos_bucketName = event.bucket;
  cos_endpoints = event.endpoint;
  cos_objectname = event.key;

  console.log("========================event: \n");
  //console.log(params);
  console.log(event);
  console.log("------------------------\n");
  console.log(cos_bucketName);
  console.log(cos_endpoints);
  console.log(cos_objectname);
  console.log("========================event: \n");
